...
export class TrainingCoursesComponent {
  courses: TrainingCourseCard[] = [
    { title: 'Parcours de formation TFE Q1', usersNumber: 9, teachersNumber: 9 },
    { title: 'Parcours de formation TFE Q2', startDate: new Date('2026-04-27'), endDate: new Date('2026-04-27'), usersNumber: 54, teachersNumber: 10 },
    { title: "Stage technologie de l'informatique le titre est super long pour tester", startDate: new Date('2026-04-27'), endDate: new Date('2026-04-27'), usersNumber: 36, teachersNumber: 10 },
  ];
}